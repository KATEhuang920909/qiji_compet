...
f_w = open("dialogue.txt", "w+",encoding="utf-8")
f_tag = open("tag.txt", "w+",encoding="utf-8")
...
f_address = open("fs_addr.conll", "r+",encoding="utf-8")
...
def diction_chinese():
	f_dic = open("chinese_dictionary.txt", "r+",encoding="utf-8")
	chinese_dic = {}
	for line in f_dic:
		line = line.strip('\n')
