...
from bigru_crf_model import BiGRUWithCRF
import pickle, json
...
if __name__ == "__main__":
    ...
    embeddings = pickle.load(open("vocab2vector.bin", "rb"))
    ...
    model = BiGRUWithCRF(dim, 256, len(word_vocab), len(label_vocab), vocab_embeddings)
